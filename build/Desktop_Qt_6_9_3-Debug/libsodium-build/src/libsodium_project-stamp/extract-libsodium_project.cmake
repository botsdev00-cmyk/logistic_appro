...
get_filename_component(directory "/home/bots/semuliki_logistic/build/Desktop_Qt_6_9_3-Debug/libsodium-build/src/libsodium_project" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-libsodium_project${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-libsodium_project${i}")
